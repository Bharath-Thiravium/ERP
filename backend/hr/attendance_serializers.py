...
class AttendanceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'check_in_location', 'check_out_location', 'check_in_latitude', 'check_in_longitude',
            'check_out_latitude', 'check_out_longitude', 'check_in_face_image', 'check_out_face_image',
            'face_match_score', 'biometric_device_id', 'work_mode', 'total_hours', 'break_hours',
            'overtime_hours', 'status', 'is_valid_checkin_location', 'is_valid_checkout_location',
            'is_valid_face_match', 'notes', 'approved_by', 'is_late', 'created_at', 'updated_at'
        ]
        read_only_fields = ['id', 'employee_name', 'employee_id', 'department_name', 'is_late', 'created_at', 'updated_at']
