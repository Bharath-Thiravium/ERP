...
const styles = StyleSheet.create({
  ...
  latestCard: { backgroundColor: '#fff', borderRadius: 24, padding: 20, borderWidth: 1, borderColor: '#dbeafe', marginBottom: 20 },
  ...
  summaryBox: { flex: 1, backgroundColor: '#f8fafc', borderRadius: 18, padding: 14 },
  ...
  payslipCard: { backgroundColor: '#fff', borderRadius: 18, padding: 16, borderWidth: 1, borderColor: '#e2e8f0', marginBottom: 10, flexDirection: 'row', justifyContent: 'space-between', gap: 12 },
  ...
  emptyCard: { backgroundColor: '#fff', borderRadius: 22, padding: 20, borderWidth: 1, borderColor: '#e2e8f0', marginBottom: 18 },
