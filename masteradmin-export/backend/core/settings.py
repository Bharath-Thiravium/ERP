...
INSTALLED_APPS = [
    ...
    # Local apps
    'authentication',
    'athens_control_plane',
    'athens_sustainability.apps.AthensSustainabilityConfig',
    'finance',
    'hr',
    'inventory',
    'orders',
...
if DEBUG:
    ...
    CORS_ALLOWED_ORIGINS = config('CORS_ALLOWED_ORIGINS', default='https://sap.athenas.co.in').split(',')
    CORS_ALLOW_CREDENTIALS = True
