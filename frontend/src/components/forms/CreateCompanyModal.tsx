  ...
  return (
    ...
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex min-h-screen items-center justify-center p-4">
        ...
        {/* Enhanced Futuristic Modal */}
        <div className="relative w-full max-w-6xl max-h-[95vh] overflow-hidden bg-white/95 dark:bg-gray-800/95 backdrop-blur-2xl rounded-3xl border border-gray-200/50 dark:border-gray-700/50 shadow-2xl shadow-gray-900/25">
